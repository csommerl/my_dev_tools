...
Note that you must install these 3 packages for every project where you need to use ESLint. Note that we are currently recommending version 7.12.1 of ESLint as later versions are currently causing difficulties.,
...
Use the following `.eslintrc.yml` file when working on Launch School projects; it's the file we expect you to use for code reviews and assessments.
